  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-pink-500 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse delay-500"></div>
      </div>
      ...
      <div className="relative w-full max-w-2xl">
        ...
        <div className="backdrop-blur-xl bg-white/10 rounded-3xl shadow-2xl border border-white/20 p-8 md:p-12">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-gray-300 text-lg">Tell us about your project and we'll get back to you within 24 hours</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="group">
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300 hover:bg-white/10"
            ...
            {/* Row 3: Website */}
            <div className="group">
              <label className="block text-sm font-medium text-gray-300 mb-2">Website / App (optional)</label>
              <input
                type="url"
                name="website"
            ...
            {/* Row 4: Service Category & Package Tier */}
            <div className="grid md:grid-cols-2 gap-6">
              <div className="group">
                ...
                <select
                  ...
                  onChange={handleChange}
                  required
                  className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300 hover:bg-white/10 cursor-pointer appearance-none"
            ...
            {/* Row 5: Budget Range & Preferred Call Time */}
            <div className="grid md:grid-cols-2 gap-6">
              <div className="group">
                ...
                >
                  ...
                  <option value="$1,000 - $5,000" className="bg-slate-900">$1,000 - $5,000</option>
                  <option value="$5,000 - $15,000" className="bg-slate-900">$5,000 - $15,000</option>
                  <option value="$15,000 - $50,000" className="bg-slate-900">$15,000 - $50,000</option>
                  <option value="$50,000+" className="bg-slate-900">$50,000+</option>
                </select>
              </div>
              <div className="group">
            ...
            <button
              ...
              className="w-full py-4 px-6 bg-gradient-to-r from-purple-600 via-pink-600 to-cyan-600 hover:from-purple-500 hover:via-pink-500 hover:to-cyan-500 text-white font-semibold text-lg rounded-xl shadow-lg shadow-purple-500/25 hover:shadow-purple-500/40 transition-all duration-300 transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
            >
              {isSubmitting ? (
